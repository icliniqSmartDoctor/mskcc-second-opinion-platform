    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="w-full bg-white  rounded-lg dark:bg-gray-800 dark:border-gray-700 h-full relative">
                    <div className='p-10 pb-20'>
                        ...
                        <div className="pt-5 text-center mt-2">
                            <a href='mskcc-india-services/remote-second-opinion'>
                                <h5 className="mb-2 text-2xl font-bold hover:text-secondary transition-colors duration-500   text-gray-700 dark:text-white">Remote Second Opinions from MSK Oncologists</h5>
                            </a>
                ...
                <div className="w-full bg-white  rounded-lg dark:bg-gray-800 dark:border-gray-700 h-full relative">
                    <div className='p-10 pb-20'>
                        ...
                        <div className="pt-5 text-center mt-2">
                            <a href='mskcc-india-services/travel-guide-to-mskcc-new-york'>
                                <h5 className="mb-2 text-2xl font-bold hover:text-secondary transition-colors duration-500   text-gray-700 dark:text-white">Care at MSK in New York</h5>
                            </a>
